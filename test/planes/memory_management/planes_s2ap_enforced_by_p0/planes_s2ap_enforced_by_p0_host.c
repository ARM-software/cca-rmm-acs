...
void planes_s2ap_enforced_by_p0_host(void)
{
    ...
    /* Prepare two granules for testing */
    data_create.size = TEST_PAGE_COUNT * PAGE_SIZE;
    ...
    val_memset((void *)phys, 0, 2 * data_create.size);
