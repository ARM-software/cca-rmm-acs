...
void mm_hipas_assigned_dev_ripas_empty_da_ia_host(void)
{
    ...
    do
    {
        ...
        ret = val_host_rmi_rtt_read_entry(realm.rd, rec_exit->dev_mem_base,
        ...
        if ((rtte.state != RMI_ASSIGNED_DEV) || (rtte.ripas != RSI_EMPTY))
        {
