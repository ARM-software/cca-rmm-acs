...
if(${SUITE} STREQUAL "all")
file(GLOB TEST_SRC
    "${ROOT_DIR}/test/*/*/*_secure.c"
    "${ROOT_DIR}/test/*/*/*_secure.S"
    "${ROOT_DIR}/test/*/common/*_secure.c"
    "${ROOT_DIR}/test/common/*_secure.c"
)
else()
file(GLOB TEST_SRC
    "${ROOT_DIR}/test/${SUITE}/*/*_secure.c"
    "${ROOT_DIR}/test/${SUITE}/*/*_secure.S"
    "${ROOT_DIR}/test/${SUITE}/common/*_secure.c"
    "${ROOT_DIR}/test/common/*_secure.c"
)
endif()
...
foreach(SUITE ${SUITE_LIST})
    ...
    foreach(TEST ${TEST_LIST})
        ...
        list(APPEND TEST_SRC ${TEST_SOURCE_DIR}/database/test_database_secure.c)
        file(GLOB TEST_COMMON_FILE ${TEST_SOURCE_DIR}/common/*_secure.c)
        foreach(COMMON_FILE1 ${TEST_COMMON_FILE})
            list(APPEND TEST_SRC ${COMMON_FILE1})
        endforeach()
        file(GLOB SUITE_COMMON_FILE ${TEST_SOURCE_DIR}/${SUITE}/common/*_secure.c)
