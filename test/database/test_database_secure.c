...
#define HOST_REALM_TEST(x, y, z)        DUMMY_TEST(x, y, z)
#define HOST_SECURE_TEST(x, y, z)       SECURE_TEST_ONLY(x, y, z)
#define HOST_REALM_SECURE_TEST(x, y, z) SECURE_TEST_ONLY(x, y, z)
