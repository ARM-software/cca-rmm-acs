...
void rhi_session_send_host(void)
{
    ...
    const char *step_desc[] = {
        ...
        "RHI_SESSION_SEND: blocking",
        "RHI_SESSION_CLOSE: blocking",
        "RHI_SESSION_SEND: invalid session id",
        "RHI_SESSION_OPEN: non-blocking (initial)",
        "RHI_SESSION_SEND: invalid state (in progress)",
        "RHI_SESSION_OPEN: non-blocking (poll to established)",
        "RHI_SESSION_SEND: misaligned buffer",
        "RHI_SESSION_SEND: non-blocking (in progress)",
        "RHI_SESSION_SEND: non-blocking (complete)",
