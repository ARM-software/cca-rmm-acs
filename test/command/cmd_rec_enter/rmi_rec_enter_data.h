...
enum test_intent {
    ...
    REC_GRAN_STATE_UNDELEGATED_INVALID_GICV3 = 0X16,
    RUN_PAS_SECURE_REC_NOT_RUNNABLE = 0X17,
    RUN_PAS_SECURE_REALM_NEW = 0X18,
    RUN_PAS_SECURE_REALM_SYSTEM_OFF = 0X19,
    RUN_DEV_MEM_REC_NOT_RUNNABLE = 0X1A,
    RUN_DEV_MEM_REALM_NEW = 0X1B,
    RUN_DEV_MEM_REALM_SYSTEM_OFF = 0X1C
};
